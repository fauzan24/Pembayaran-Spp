...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2024 at 06:15 AM
...
(32, 1, '321', '2024-09-30', 'September', '2024', 5, 100000),
(33, 1, '321', '2024-09-30', 'September', '2024', 5, 100000),
(34, 1, '123', '2024-10-01', 'Oktober', '2024', 5, 100000);
...
('123', '123', 'jaki', 2, 'jln mengkudu', '08764711', 5),
('321', '321', 'gaga', 2, 'kolam', '0854711445', 5);
...
ALTER TABLE `pembayaran`
  ...
  ADD KEY `id_petugas` (`id_petugas`,`nisn`,`id_spp`) USING BTREE,
  ADD KEY `nisn` (`nisn`),
...
ALTER TABLE `siswa`
  ...
  ADD KEY `id_kelas` (`id_kelas`,`id_spp`) USING BTREE,
  ADD KEY `id_spp` (`id_spp`);
...
ALTER TABLE `spp`
  ...
  ADD KEY `tahun` (`tahun`,`nominal`) USING BTREE;
